...
/**
 * a class whose instances represent the concept of pair
...
public class Pair<T1,T2> {
     ...
     * it is equal with the object if it is of Pair instance and the attributes are equal (first with first,
     * second with second)
