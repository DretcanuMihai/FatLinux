...
public class SuperService {
    ...
    public void createUserAccount(String email, String encryptedPassword, String firstName, String lastName)
        ...
        userService.createUserAccount(email, encryptedPassword, firstName, lastName);
    }
     ...
     */
    public void updateUser(String email, String encryptedPassword, String firstName, String lastName)
            throws ValidationException, AdministrationException {

        userService.updateUserAccountInfo(email, encryptedPassword, firstName, lastName);
    }
     ...
     *
     * @param userEmail         - said user's email
     * @param encryptedPassword - said user's encrypted password
     * @return said user
     * @throws ValidationException     - if said user's email is invalid
     * @throws AdministrationException - if credentials are invalid
     */
    public UserUIDTO login(String userEmail, String encryptedPassword) throws ValidationException, AdministrationException {
        User user = userService.login(userEmail, encryptedPassword);
