package com.fatlinux;

import com.fatlinux.controllers.AbstractControllerWithTitleBar;
import com.fatlinux.controllers.MainControllerWithTitleBar;
import com.fatlinux.model.entities_dto.UserPage;
import com.fatlinux.model.validators.*;
import com.fatlinux.repository.skeletons.entity_based.*;
import com.fatlinux.repository.with_db.*;
import com.fatlinux.service.*;
...
public class MainApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        changeToLogin();
        primaryStage.getIcons().add(new Image("com/fatlinux/images/fatLinux0.png"));
        primaryStage.show();
    }
}
