...
public class AbstractControllerWithTitleBar extends AbstractController {
    ...
    @FXML
    Pane titleBar;
    Image appExitHoveredButton = new Image("com/fatlinux/images/closeHover.png");
    Image appMaximizeHoveredButton = new Image("com/fatlinux/images/maxHover.png");
    Image appMinimiseHoveredButton = new Image("com/fatlinux/images/minHover.png");
