...
import com.fatlinux.model.entities_dto.MessageDTO;
...
import com.fatlinux.utils.Constants;
import com.fatlinux.utils.events.ChangeEventType;
import com.fatlinux.utils.events.EntityModificationObsEvent;
import com.fatlinux.utils.observer.Observer;
import com.fatlinux.utils.structures.ConversationCustomVBox;
import com.fatlinux.utils.styling.ButtonStyling;
import com.fatlinux.utils.styling.TextColoring;
...
public class InboxController extends AbstractController {
    ...
    public void initComposeMessageScene() throws IOException {
        URL composeMessageURL = getClass().getResource("/com/fatlinux/views/composeMessage-view.fxml");
    ...
    protected class MessageCell extends ListCell<MessageDTO> {
        ...
        ImageView imageView = new ImageView("com/fatlinux/images/messageListIcon.png");
