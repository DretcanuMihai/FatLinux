...
public class ButtonStyling {
    ...
    public void setButtonForSearchEvent(Button button) {
        button.setStyle("""
                ...
                -fx-background-image: url("/com/fatlinux/images/searchIcon.png");
    ...
    public void setButtonForCancelSearchEvent(Button button) {
        button.setStyle("""
                -fx-background-radius: 0 20 20 0;
                -fx-background-color: black;
                -fx-background-image: url("/com/fatlinux/images/cancelSearchIcon.png");
                -fx-background-size: 20;
                -fx-background-repeat: no-repeat;
                -fx-background-position: center;
                """);
    ...
    public void setJFXButtonWithNotificationBubble(JFXButton button, String buttonText, ImageView buttonImage, String numberOfNotifications, boolean visibleBubble) {
        ImageView notificationBubble = new ImageView("com/fatlinux/images/notificationRedBubbleIcon.png");
    ...
    public void setButtonToDisableNotifications(Button button) {
        ImageView disableNotificationsImage = new ImageView("com/fatlinux/images/disableNotificationsIcon.png");
    ...
    public void setButtonToEnableNotifications(Button button) {
        ImageView enableNotificationsImage = new ImageView("com/fatlinux/images/enableNotificationsIcon.png");
